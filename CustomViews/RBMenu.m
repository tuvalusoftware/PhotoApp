...
NSInteger const MENU_ITEM_DEFAULT_FONTSIZE    = 16;
...
-(void)showMenu{
    ...
    if(self.currentMenuState == RBMenuShownState || self.currentMenuState == RBMenuDisplayingState){
        ...
        // notify owner that the menu is starting transitionig upward
        NSNotification *notification = [NSNotification notificationWithName:MESSAGE_DROP_DOWN_MENU_START  object:self userInfo:nil ];
    ...
    [UIView animateWithDuration:.2 animations:^{
        ...
        [UIView animateWithDuration:.2 animations:^{
            ...
            if(finished){
                ...
                // notify owner that the menu is starting transitionig upward
                NSNotification *notification = [NSNotification notificationWithName:MESSAGE_DROP_DOWN_MENU_COMPLETE  object:self userInfo:nil ];
                [[NSNotificationQueue defaultQueue]
                 enqueueNotification:notification
                 postingStyle:NSPostASAP];
